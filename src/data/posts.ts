...
export const MOCK_POSTS: Post[] = [
  ...
  //     <h2>どんな拡張機能か</h2>
  //     <p>端的に言うと、ブラウザ上で動くFigmaインスペクターです。</p>
  //     <p>拡張機能をONの状態でブラウザの要素をホバーすると、その要素のスペース情報やHTMLのクラス情報が表示されます。そしてクリックするとフォントや画像情報、コンポーネント情報といったより詳細な情報を表示することができます。</p>
  //     <h2>なぜ作ったのか</h2>
  //     <p>ブラウザにはとても便利な開発者ツールがビルトインで搭載されています。サイトのスタイル情報やHTML構成を見るためには重宝しており、誰でも利用できます。</p>
