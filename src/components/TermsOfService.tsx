    ...
    <article className="animate-in">
      ...
      >
        ...
        <section>
          <h2>第3条（サービス内容）</h2>
          <p>
            本サービスは、ブラウザ上でお気に入り画像を表示するChrome拡張機能を提供します。
          </p>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              解約は拡張機能の設定画面内「アカウント」からサブスクリプション管理画面（Stripe）にて手続きできます。
            </li>
            <li>
            ...
            <li>
              システム障害によりサービスを利用できなかった場合は、個別に対応いたします。
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              やむを得ない事由（天災、法令変更、セキュリティ上の緊急対応等）がある場合を除き、30日前までに通知した上で、本サービスの内容を変更、または提供を中止することがあります。
            </li>
            <li>
        ...
        <section>
          ...
          <p className="mt-4">
            ユーザーが本サービスにアップロードした画像等のコンテンツに関する権利は、ユーザーに帰属します。
          </p>
        </section>
        ...
        <section>
          <h2>第9条（規約の変更）</h2>
          <p>
            当サービスは、必要に応じて本規約を変更することがあります。変更が利用者の一般の利益に適合する場合、または変更の必要性・相当性が認められる場合に限り、変更内容および発効日を本ページに掲載し、発効日の30日前までにユーザーに通知します。通知後30日以内に解約しない場合、変更に同意したものとみなします。
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            本規約の解釈にあたっては日本法を準拠法とします。本サービスに関する紛争については、さいたま地方裁判所を第一審の合意管轄裁判所とします。
          </p>
        </section>
